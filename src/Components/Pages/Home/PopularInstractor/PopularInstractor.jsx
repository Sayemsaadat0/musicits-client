    ...
    return (
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mx-10'>
            <div className="card image bg-base-100 shadow-xl">
                ...
                <img className="" src="https://i.ibb.co/VQLs2zW/1.png" />
            </div>
            <div className="card image bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                </div>
                <img className="" src="https://i.ibb.co/p3Ktw7V/2.png" />
            </div>
            <div className="card image bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                </div>
                <img className="" src="https://i.ibb.co/P6mMt69/3.png" />
            </div>
            <div className="card image bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                </div>
                <img className="" src="https://i.ibb.co/y4NfnCT/4.png" />
            </div>
            <div className="card image bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                </div>
                <img className="" src="https://i.ibb.co/TqPSxzT/5.png" />
            </div>
            <div className="card image bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                </div>
                <img className="" src="https://i.ibb.co/JFHbSYR/6.png" />
            </div>
            <div className="card image bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                </div>
                <img className="" src="https://i.ibb.co/4ZyPt1H/7.png" />
            </div>
            <div className="card image bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                </div>
                <img className="" src="https://i.ibb.co/6rG3Pkd/8.png" />
            </div>
        </div>
        </div>
    );
